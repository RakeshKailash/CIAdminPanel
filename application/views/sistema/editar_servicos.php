...
$registro = $this->secoes_sistema->getInfo(2)[0];
				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<form action="<?php echo base_url('sistema/servicos/editar'); ?>" method="post" enctype="multipart/form-data">
									...
									<div class="x_content"> <!-- X-Content -->
										...
										<input type="hidden" name="has_img" value="true" id="has_img">
