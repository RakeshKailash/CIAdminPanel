...
$registro = $this->secoes_sistema->getInfo(5)[0];
$secoes = $this->secoes_sistema->getInfo();
$contato = $this->contatos_model->retrieve(1);
				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<form data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url('sistema/contato/editar'); ?>" method="post" enctype="multipart/form-data">
									...
									<div class="x_content">
										...
										<div class="form-group">
											<input type="checkbox" name="form_email" id="form_email" value="1" class="flat" />
									...
									<div class="x_content"> <!-- X-Content -->
										...
										<input type="file" name="imagem" style="display: none;" id="imagem_contato">
										<input type="hidden" name="has_img_contato" value="true" id="has_img_contato">

										<div id='img_selecionada_contato'>
											<?php echo $imagem; ?>
										</div>
										<button type="button" class="btn btn-primary" id="select_img_contato">Selecionar Imagem</button>
										<button type="button" class="btn btn-danger" id="remove_img_contato">Remover Imagem</button>
